...
if not os.listdir(str(os.path.dirname(os.path.abspath(_file_))) +'/data/glove_data'):
    print('Download the GloVe embeddings from the webpage first!')

if not len(os.listdir(str(os.path.dirname(os.path.abspath(_file_))) +'/data/subjects'))==15:
...
save_file =str(os.path.dirname(os.path.abspath(_file_)))+'/model_weights/Subject' +subject+'_main_model.h5'
...
text_all = open(str(os.path.dirname(os.path.abspath(_file_))) + "/results/Subject" +subject+"_main_model.txt", "a+")
